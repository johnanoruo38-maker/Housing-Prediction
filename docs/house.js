/**
 * script.js — EstimateIQ House Price Predictor
 * Handles form validation, API communication, and UI state transitions.
 */
    ...
    switch (state) {
        case UIState.IDLE:
            ...
            case UIState.LOADING:
                ...
                dom.submitBtn.querySelector(".btn-text").textContent = "Analyzing.....";
                break;
...
function validate() {
    ...
    if (!dom.roomsEl.classList.value || isNaN(rooms) || rooms < 1 || rooms > 20 || !Number.isInteger(rooms)) {
